...
const sections: Section[] = [
  {
    ...
    cta: "swipe / scroll cube to explore sections",
    icon: (
      <svg
  ...
  },
  {
    name: "blog",
    title: "Ziro2Mach",
    subtitle: "learnings and blog posts!",
  ...
  },
  {
    ...
    cta: "double click cube to go to /projects",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
